<template>
  <div>
    ...
    <el-table :data="page.list" border style="width: 100%" @sort-change="changeSort">
      ...
      <el-table-column prop="typeName" label="分类" width="120" sortable="custom" />
      ...
      <el-table-column prop="blogGoods" label="点赞数" width="120" sortable="custom" />
      <el-table-column prop="blogRead" label="阅读数" width="120" sortable="custom" />
      <el-table-column prop="blogCollection" label="收藏数" width="120" sortable="custom" />
      <el-table-column prop="blogComment" label="评论数" width="120" sortable="custom" />
      <el-table-column prop="blogSource" label="文章来源" width="120" />
      <el-table-column prop="createdTime" label="创建时间" width="120" sortable="custom" />
      <el-table-column prop="updateTime" label="修改时间" width="120" sortable="custom" />
